...
> 注: `sources/` 中的 4 个文件为**符号链接** (symlink) 指向 `E:\__work\__frequently\value_pipeline\acim-ml\书籍\`, 源文件更新时此处实时同步, 零磁盘占用。

### 检索脚本 (scripts/)

**PowerShell** (Windows):
```powershell
pwsh "C:\Users\yg\.claude\skills\acim\scripts\search-sources.ps1" -Query "宽恕"
pwsh "C:\Users\yg\.claude\skills\acim\scripts\search-sources.ps1" -Query "神圣一刻" -Source "acim-1.正文.md" -Context 3
pwsh "C:\Users\yg\.claude\skills\acim\scripts\search-sources.ps1" -Query "第一百二十一课" -MaxHits 5
```

**Bash** (git-bash / WSL):
```bash
bash "C:/Users/yg/.claude/skills/acim/scripts/search-sources.sh" "宽恕"
bash "C:/Users/yg/.claude/skills/acim/scripts/search-sources.sh" "小我" --source acim-1.正文.md --context 3 --max 50
bash "C:/Users/yg/.claude/skills/acim/scripts/search-sources.sh" "W-121"
```
...
**直接 grep / rg**:
```bash
rg "宽恕" "C:/Users/yg/.claude/skills/acim/sources/"
rg "T-15\.V" "C:/Users/yg/.claude/skills/acim/sources/acim-1.正文.md"
```
...
## 范围与限制
本 skill 仅覆盖四部中文文本内容。章节文件为综合摘要, 非原文; 引用原句时通过扩展层 `sources/` 检索或标注章节出处。回答风格遵循项目设定: 明确的导师口径, 结论先行, 电路/代码/机器学习类比。
